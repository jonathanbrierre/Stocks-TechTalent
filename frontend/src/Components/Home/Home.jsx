    ...
    render() {
        return (
            <div className = 'login'>
                ...
                (Note - Your initial authentication may take a few seconds and throw an error due to an async fetch from a heroku server - If you get an error, please try a second time) <br></br>
